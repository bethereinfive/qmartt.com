<template>
  <div>
    ...
    <div data-v-8c4b8248="" id="home">
                    <div data-v-8c4b8248="" id="user_message">
                        <div data-v-8c4b8248="" id="avatar">
                            <img data-v-8c4b8248="" :src="$asseturl+'frontend2/static/img/smallLogo.png'" alt="" />
                        </div>
                        <div data-v-8c4b8248="" id="message"><p data-v-8c4b8248="">{{ user.user.mobile }}</p></div>
                        <!-- <router-link :to="{name:'Recharge'}" data-v-8c4b8248="" class="right"><span data-v-8c4b8248="">Recharge</span></router-link> -->
                    </div>
                    <div data-v-8c4b8248="" id="swiper_list" class="swiper-no-swiping">
                        <div data-v-8c4b8248="" class="swiper-container swiper-container-initialized swiper-container-vertical">
                            <marquee> {{ settings.notice }}</marquee>
                        </div>
                    </div>
                    <div data-v-8c4b8248="" id="income_message">
                        <div data-v-8c4b8248="" id="total">
                            <p data-v-8c4b8248=""><span data-v-8c4b8248="">৳</span>{{ user.user.balance }}</p>
                            <p data-v-8c4b8248="">+৳{{ parseFloat(user.todayearn).toFixed(2) }} Today</p>
                        </div>
                        <div data-v-8c4b8248="" class="right">
                            <div data-v-8c4b8248="" class="item">
                                <p data-v-8c4b8248=""><span data-v-8c4b8248="">৳</span>{{ user.registration_bonus }}</p>
                                <p data-v-8c4b8248="">Gift money</p>
                            </div>
                            <div data-v-8c4b8248="" class="item">
                                <p data-v-8c4b8248=""><span data-v-8c4b8248="">৳</span>{{ parseFloat(user.taskearn).toFixed(2) }}</p>
                                <p data-v-8c4b8248="">Total income</p>
                            </div>
                        </div>
                    </div>

                    <div data-v-8c4b8248="" class="nav">
                        <div data-v-8c4b8248="" class="item on">Products</div>
                        <!-- <div data-v-8c4b8248="" class="item">
                            Premium products <span data-v-8c4b8248="" class="vipTips"><img data-v-8c4b8248="" :src="$asseturl+'frontend2/static/img/jiaobiao_en-GB.f3ca793f.gif'" alt="" /></span>
                        </div> -->
                    </div>
                    <div data-v-8c4b8248="" id="goods_list">


                        <div data-v-8c4b8248="" v-for="p in products">
                    ...
                    <!-- <div data-v-8c4b8248="" class="join">
                        <a data-v-8c4b8248="" href="/redpack" class=""><img data-v-8c4b8248="" :src="$asseturl+'frontend2/static/img/right_en-GB.d5bbf035.gif'" alt="" /></a>
                    </div>
                    <div data-v-8c4b8248="" class="join1"><img data-v-8c4b8248="" :src="$asseturl+'frontend2/static/img/right2_en-GB.b93340a0.gif'" alt="" /></div> -->
                    <!---->
                </div>
