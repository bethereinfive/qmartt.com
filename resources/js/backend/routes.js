...
let blanklayout2 = require('./components/layouts/blanklayout2.vue').default;
...
let Usertask = require('./components/users/job.vue').default;
//////////////////
...
//menu
  ...
  { path:  `${prefixuser}/Recharge`, component: Recharge, name:'Recharge',meta: { layout: blanklayout2 } },
  { path:  `${prefixuser}/onepay/Recharge`, component: rechargepage, name:'rechargepage',meta: { layout: blanklayout2 } },
  { path:  `${prefixuser}/onepay/checkout`, component: rechargecheckout, name:'rechargecheckout',meta: { layout: blanklayout2 } },
  { path:  `${prefixuser}/onepay/patment/success`, component: rechargesuccess, name:'rechargesuccess',meta: { layout: blanklayout2 } },
  { path:  `${prefixuser}/onepay/patment/failed`, component: rechargeFailed, name:'rechargeFailed',meta: { layout: blanklayout2 } },
